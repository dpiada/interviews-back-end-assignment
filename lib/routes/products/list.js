...
module.exports = {
  ...
  handler: async (request, reply) => {
    ...
    const { page, size, category_id, search, availability } = request.query

    const products = await productService.listAllProducts({ page, size, category_id, search, availability });
